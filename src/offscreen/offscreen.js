...
const OCR_CONFIG = {
    ...
    RELIABLE_CONFIDENCE: 50,
    RELIABLE_MIN_CHARS: 8,
    RELIABLE_MIN_TOKENS: 2,
    RELIABLE_READABLE_RATIO: 0.60,
    RELIABLE_WORD_MEDIAN_CONFIDENCE: 45,
    RELIABLE_WORD_MIN_CONFIDENCE: 40,
    RELIABLE_WORD_MIN_PASS_RATIO: 0.6
};
